<template>
    <div class="lg:flex items-center justify-between w-full lg:space-y-0 space-y-4">
        ...
        <div class="flex items-center lg:justify-end justify-between space-x-4 w-full">
            ...
            <div class="flex items-center relative lg:space-x-3">
                <!-- <div v-if="filters" class="text-sm tracking-wider pl-3 rounded-md border bg-gray-50 bg-opacity-50 flex space-x-3 divide-x items-center overflow-hidden">
                    <span>Filter</span>
                    <div class="px-3 py-1 bg-white flex items-center">
                        <select class="focus:outline-none px-3">
                ...
                <yng-button btnColor="light">
                    Filter
                    <template #icon-right>
                        <svg class="lg:w-4 lg:h-4 w-6 h-6 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z"></path></svg>
                    </template>
                </yng-button>
                ...
                <div @mouseleave="isOpen = false" v-if="isOpen" class="absolute md:block hidden right-0 top-0 mt-8 space-y-2 border rounded-md bg-white z-20 p-4">
        ...
        <teleport  to="#modals">
            <yng-modal :show="isOpen" @close="isOpen = false" class="md:hidden">
                <template #title>More Options</template>
                <div class="px-6 block space-y-2 tracking-wide">
                    <label for="boxed" class="block whitespace-nowrap space-x-2">
                        <input type="radio" v-model="borderStyle" value="boxed" id="boxed" name="borderStyle">
                        <span>Boxed</span>
                    </label>
