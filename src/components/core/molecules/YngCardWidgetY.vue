...
export default {
    ...
    computed: {
        ...
        iconPosition() {
            return this.iconPlacement === 'top' ? 'order-3' : ''
        }
    }
}
</script>